...
def read_user_cli_args():
    ...
    parser.add_argument("-i", "--imperial", action = "store_true", help = "Display temperature in imperial units.")
...
def build_weather_query(city_input, imperial = False):
    ...
    unit = "imperial" if imperial else "metric"
    url = f"{BASE_WEATHER_API_URL}?q={url_encoded_city_name}&units={unit}&appid={api_key}"
    return url
